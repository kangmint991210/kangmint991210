  ...
  "areas": [
    {
      ...
      "record": "· 3월 10일 — 자동차 놀잇감을 바닥에 내려놓고 손으로 앞뒤로 밀어봄.\n· 멈춘 자동차의 바퀴를 뚫어지게 응시하다가, 손가락으로 살짝 건드려 돌려봄.\n· 바퀴가 멈추면 다시 돌리는 과정을 여러 번 반복함.\n· 3월 17일 — 공룡 모형을 양손에 하나씩 쥐고 바닥에 쾅 찍어봄.\n· 모형을 높이 들었다가 떨어뜨리고, 떨어진 위치를 고개 숙여 확인한 뒤 다시 집음.\n· 꼬리와 등 부분을 손가락으로 훑으며 질감을 느껴봄.\n· 교사가 다가가자 공룡을 등 뒤로 숨겼다가 다시 꺼내어 보여줌.",
      "interpretation": "· [자연탐구 > 탐구과정 즐기기] 사물의 움직임을 반복해 확인하며 지적 호기심이 발달하고 있음.\n· [자연탐구 > 생활 속에서 탐구하기] 구체적인 사물을 조작하며 물리적 특성을 익히고 있음.\n· 같은 동작을 되풀이하는 과정에서 인과관계를 이해하려는 시도가 관찰됨.\n· 사물을 다루는 소근육 조절 능력이 점차 정교해지고 있음.\n· 더 복잡한 구조나 다양한 재질의 놀잇감을 제공해 탐구 범위를 넓혀 줄 필요가 있음.",
            ...
            return (
              <Reveal key={m.key} delay={i * 40}>
                <button className="feat-card" style={styles.featCard}
                  ...
                  <span className="feat-tile" style={styles.featTile(m.tint, free ? [m.color, m.color2] : null)}>
