...
export const MODES = [
  ...
  // tint/tint2 는 랜딩 타일 바탕의 위·아래 색입니다.
  // 마크 색과 따로 두는 이유 — 바탕만 바꾸고 싶을 때가 있습니다(놀이활동 노랑, 보육일지 분홍).
  // color/color2 는 랜딩의 아이콘 마크 그라디언트에 씁니다 (features/landing/DocGlyphs.jsx).
  // 12개가 한눈에 구분되도록 색상환을 고루 나눠 씁니다.
  { key: "play", label: "놀이 활동", emoji: "🖍️", color: "#5FD8BE", color2: "#2A9E86", tint: "#FFF6CE", tint2: "#F9E294" },
  { key: "daily", label: "보육일지", emoji: "📔", color: "#63D0C0", color2: "#1E8F94", tint: "#FFE9F0", tint2: "#F8C5D8" },
  { key: "obs", label: "관찰일지", emoji: "🔎", color: "#7CC4F5", color2: "#3B7FD4", tint: "#EAF4FE", tint2: "#CFE4FB" },
  { key: "note", label: "알림장", emoji: "💌", color: "#FFAE86", color2: "#F4694F", tint: "#FFF0E9", tint2: "#FCD9C9" },
  { key: "adapt", label: "신입원아 적응일지", emoji: "🐣", color: "#F5C98E", color2: "#D79046", tint: "#FFF4E6", tint2: "#FBE3C4" },
  { key: "counsel", label: "학부모 상담일지", emoji: "🗣️", color: "#FFCB73", color2: "#F09322", tint: "#FFF5E4", tint2: "#FCE5BE" },
  { key: "life", label: "생활기록부", emoji: "📗", color: "#93E0AE", color2: "#3FA96C", tint: "#EAFAF0", tint2: "#CFF0DC" },
  { key: "assess", label: "발달평가 총평", emoji: "📊", color: "#8FB6F5", color2: "#4759D6", tint: "#EDF2FE", tint2: "#D5DFFB" },
  { key: "monthly", label: "월간 평가", emoji: "🗓️", color: "#6FD5E4", color2: "#2A9FC4", tint: "#E7F8FB", tint2: "#C7EDF4" },
  { key: "safety", label: "안전교육일지", emoji: "🛟", color: "#FFC06B", color2: "#EF7A3D", tint: "#FFF3E4", tint2: "#FCE0BF" },
  { key: "trip", label: "견학 계획안", emoji: "🚌", color: "#A8A6F5", color2: "#6C5CE0", tint: "#EFEEFE", tint2: "#DAD7FA" },
  { key: "event", label: "행사 계획안", emoji: "🎪", color: "#F9A8C8", color2: "#E05A96", tint: "#FEEDF4", tint2: "#FAD3E4" },
];
